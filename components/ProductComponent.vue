  ...
  <div :id="`ProductComponent${product.id}`"
    ...
    <NuxtLink :to="`/item/${product.id}`">
      ...
      <div id="ProductDetails">
        ...
        <span class="px-1 relative -top-1.5 text-[#ff4646] text-xs font-semibold">
          Extra 5% off
        </span>
        <div class="flex items-center gap-1 px-1 relative -top-1">
          <span class="bg-[#ff4646] text-white text-[9px] font-semibold px-1.5 rounded-sm">Welcome Deal</span>
